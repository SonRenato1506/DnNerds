...
$sql = "SELECT * FROM noticias WHERE palavrachave = 'harrypotterbox' LIMIT 1";
...
$sqlRelacionadas = "SELECT * FROM noticias 
                    ...
                    AND palavrachave != 'harrypotterbox'
...
<body>
    <header>
        <nav class="navbar">
            <h2 class="title">DnNerds <img src="../../Imagens/favicon.png?v=2?v=2?v=2" alt=""></h2>
            <ul>
