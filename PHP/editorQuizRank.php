...
<header>
    <nav class="navbar">
        ...
        <ul>
            ...
            <li><a href="quizRank.php?id=<?= $quiz_id ?>">Ver Quiz</a></li>
        </ul>
    </nav>
</header>
    ...
    <form method="POST">
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="item[<?= $i['id'] ?>][nome]" value="<?= htmlspecialchars($i['nome']) ?>">
                </td>
                <td>
                    <input type="text" name="item[<?= $i['id'] ?>][dica]" value="<?= htmlspecialchars($i['dica']) ?>">
                </td>
